...
previously hosted in the langkit-query-language repository and has since been
moved here.
...
LKQL; GNATcheck ships with a set of predefined rules, and users may write their
own.
