...
package Lkql_Checker.Output is
   ...
   --  Get the normalized path to the GNATcheck log file.

   procedure Print_Usage;
   --  Print the tool help, in the format generated by other GNAT tools for
   --  the '--help' option. Output is sent to Stdout.
